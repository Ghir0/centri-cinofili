...
export function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-[1100] md:hidden bg-white border-t border-[color:var(--ds-gray-100)] pb-safe">
      <div className="flex items-center justify-around h-14 px-2">
        <a
          href="/#cerca"
          className={`flex flex-col items-center justify-center gap-0.5 flex-1 h-full transition-colors no-underline ${
